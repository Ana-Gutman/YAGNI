export class LoteDTO {
    ...
    constructor(id_lote: number, id_cocina: number, id_local_destino: number, id_refrigerador: number, id_producto: number, cantidad: number, entregado?: boolean, fecha_retirado?: Date) {
